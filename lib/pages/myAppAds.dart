...
class myAppAds extends StatefulWidget {
  ...
  @override
  _myAppliedAdsState createState() => _myAppliedAdsState();
}

class _myAppliedAdsState extends State<myAppAds> {
        ...
        body: Container(
          child: StreamBuilder(
              stream: Firestore.instance
                  .collection("ads")
                  .where("applied", arrayContains: widget.uid).where("phase",isEqualTo: 1)
                  .snapshots(),
              builder: (_, snapshot) {
