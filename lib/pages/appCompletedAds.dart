...
class _completedAppAds extends State<completedAppAds> {
  ...
  navigateToDetailCom(DocumentSnapshot ad) {
    Navigator.push(
        context,
        MaterialPageRoute(
        ...
        body: Container(
          child: StreamBuilder(
              stream: Firestore.instance
                  .collection("ads")
                  .where("worker", isEqualTo: widget.uid).where("phase",isEqualTo:3)
                  .snapshots(),
              builder: (_, snapshot) {
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Center(
                              child: Text(
                                "You have not completed any Ads yet...",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontFamily: 'Raleway',
                                    fontSize: 30.0,
